...
suoraan laitteistotason konekielelle käännettynä. Natiivirajapinnan
käyttäminen C++-kielessä eroaa hyvin vähän C-kieleen verrattuna, eikä
suorituskykyeroa kielten välillä ole @@jnibook(106). Käsittelen tässä
rajapinnan C-kielistä versiota.
...
/ristiinkääntämistä/, koska kohdelaitteiston ARM-arkkitehtuuri ja
...
Olen ennakoinut, että natiivirajapinnan ylittäminen voi aiheuttaa
