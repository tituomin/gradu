...
kutsua Java-ohjelman metodeita ja käyttää sen tietorakenteita. Tässä
yhteydessä kielten luokittelu matalan ja korkean tason kieliin ei
perustu kielen abstraktiomekanismien ilmaisuvoimaan vaan kielen
toteutustapaan: Java on korkean tason kieli, sillä Java-ohjelmia
suoritetaan välikielen muodossa abstraktissa virtuaalikoneessa eikä
suoraan laitteistotason konekielelle käännettynä.
...
UTF-8 -koodauksen merkkijonoon @@jnitips; lähes kaikista
