...
C-kieliset tyyppinimet määritellään
...
** Oliot ja luokat
Yksittäistä mielivaltaisen tyyppistä Java-oliota käsitellään hieman
vastaavasti. Olion kenttien käsittely ja metodien kutsuminen tapahtuu
...
** Viitteet ja muistinhallinta
Lopuksi vielä maininta 
