...
ohjelmaksi on pääpiirteissään seuraavanlainen, kun käytössä on
Dalvik-virtuaalikone. Aluksi sovellus käännetään Java-lähdekoodista
tavallisella Java-kääntäjällä luokkatiedostoiksi, jotka sisältävät
standardinmukaisen Java-virtuaalikoneen ymmärtämää välikieltä,
Java-tavukoodia.
...
Käsittelemme tässä lyhyesti ART-virtuaalikoneen merkittävimmät erot
...
Arvioimme tutkielman tulosten sovellettavuutta ART-virtuaalikoneeseen
lyhyesti tutkielman yhteenvedossa.
