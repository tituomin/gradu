...
jo nyt havaita, että JNI:n käyttö järjestelmän sisäisessä
toteutuksessa on yleistä, kun Java-koodista on kutsuttava matalamman
arkkitehtuuritason natiiveja kirjastoja.
# todo sisäinen viite
...
järjestelmäpalvelut kutsuvat itse natiivikirjastoja JNI:n
kautta. Lisäksi jotkut Android-ohjelmointirajapinnan luokat kutsuvat
natiivikirjastoja suoraan JNI:n avulla ohittaen
järjestelmäpalvelutason: esimerkiksi ~Log~-luokka kutsuu suoraan
~liblog~-natiivikirjastoa.
# lähde: binder.pdf

Järjestelmäpalveluita matalammalla olevia arkkitehtuuritasoja en
käsittele sen tarkemmin. Mainittakoon kuitenkin, että Androidin Native
...
varten NDK:n natiivirajapinnat ovat riittäviä. Ne sisältävät
esimerkiksi tuen OpenGL- ja bittikarttagrafiikalle, ääni- ja
