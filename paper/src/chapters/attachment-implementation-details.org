...
perusarkkitehtuuri. Kuvan alaosasta nähdään, että Ant-käännöstyökalu on konfiguroitu
kutsumaan automaattisesti ~benchmark_generator~-päämoduulia, ja
generoidut lähdekooditiedostot tulevat näin osaksi normaaleja
Androidin SDK- ja NDK- käännösprosesseja.
...
mittausten jälkeen välttää turhien testien aikaavievä suoritus --
