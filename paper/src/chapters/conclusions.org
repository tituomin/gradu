...
ominaispiirteitä suorituskyvyn näkökulmasta. Tutkielman mittauksissa
yhdistettiin kahta menetelmää. Toisaalta käytettiin
vasteaikamittauksia, jossa mitattavia JNI-operaatiota toistettiin
silmukassa ja mitattiin suorituksen kokonaisvasteaika. Toisaalta
samoja operaatioita tutkittiin näytteenottomenetelmällä, jossa
prosessorin tilasta ja erityisesti kutsupinosta otetaan tasaisin
väliajoin näytteitä, joista muodostetaan koko mittausjakson ajalta
/kutsuprofiili/. Menetelmiä yhdistelemällä saatiin selville paitsi
riippuvuuksia eri parametrien ja kokonaisvasteajan välillä, myös
Dalvik-virtuaalikoneen sisäisen toteutuksen osat, joiden kesken
suoritusaika jakautui.
...
aiheuttaa Dalvikin JNI-rajapinnan käytön merkittävimmät
rasitteet. Jokaisessa rajapinnan operaatiossa ja jokaisessa sen kautta
tehdyssä aliohjelmakutsussa on myös merkittävä pohjarasite, joten
...
Muita mielenkiintoisia kehityskohteita olisi varioida ja tutkia
...
mittauskohteisiin lisättäisiin edustavia korkeamman tason
käyttötapauksia, jotka edustaisivat paremmin todellisten sovellusten
tarpeita ja joissa samassa benchmarkissa käytettäisiin useita
