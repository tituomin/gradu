...
arvioin tutkielmassa arkkitehtuurimalleja suorituskykykeskeisille
Android-sovelluksille tapauksissa, joissa osa sovelluksen
komponenteista on kirjoitettu Java- ja osa C-ohjelmointikielellä.
...
/siirrettävä/.[fn:ios] Kolmas ja tämän tutkielman kannalta oleellisin
...
käännetään laitteiston prosessorin konekielelle, tällä
