...
myös C- tai C++ -kielisiä komponentteja. Javan lupaus
...
Joidenkin Android-sovellusten kehitysprosessin loppuvaiheessa ei
kuitenkaan välttämättä enää ehdi korjata suorituskykyongelmia, jos ne
kumpuavat varhaisista valinnoista kuten käytetyistä
ohjelmointikielistä, ohjelmiston rakenteellisista ominaisuuksista ja
komponenttien väliseen kommunikaatioon liittyvistä ratkaisuista. SPE:n
keskeisiä väitteitä onkin, että ohjelmiston makrotason
/arkkitehtuurin/ suunnittelu on usein suorituskyvyn kannalta vähintään
yhtä oleellinen tekijä kuin mikrotason optimoinnit.
