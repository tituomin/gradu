...
suositellaan säilyttämään metodien ja kenttien tunnisteet omissa
muuttujissaan, kun ne on kerran selvitetty. Paras käytäntö on tehdä
~GetMethodID~-kutsut erillisessä natiivimetodissa, jota kutsutaan sen
Java-luokan staattisessa alustuslohkossa, jonka metodeja
natiivikomponentti tulevaisuudessa kutsuu @@jnibook(56).
Virtuaalikone takaa, että luokan staattinen alustuslohko suoritetaan ennen
kuin luokan metodeja voi kutsua.
...
*** lainaus ylle :noexport:
    The virtual machine always executes the static initializer of a class
    before it invokes any of the methods in that class. Thus a suitable place for com-
    puting and caching field or method IDs is in the static initializer of the class that
    defines the fields or methods. @@jnibook(56)
