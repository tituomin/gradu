...
osoitteen saaminen merkkijonon muistialueelle. Jälkimmäisen tapauksen
...
jälkeen merkittävä kustannus (8.44%) syntyy jälleen muistinhallintaan
...
erityistapauksenaan. Osoittimen palauttavia operaatiota mitataan
...
Primitiivitaululukoiden operaatioissa odotetusti 
