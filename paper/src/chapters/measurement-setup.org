...
/Benchmark Generator/ on pythonkielinen ohjelma, joka tuottaa edellä
kuvatun ohjelman lähtösilmukat sekä kutsujen kohteena olevat
tynkämetodit. Ohjelma myös tulostaa c-kieliset moduulit sekä Java-kieliset
luokat, joihin kyseiset silmukat ja metodit sijoitetaan.
