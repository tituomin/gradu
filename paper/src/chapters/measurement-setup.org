...
ja kutsukohteista muodostuvia permutaatioita. Aluksi kutsu Javasta C:hen.
...
Seuraava kuva \ref{fig:sequence_c_to_java} esittää päinvastaista tilannetta, jossa 
C-natiivikirjastosta kutsutaan Java-ohjelmaa.
