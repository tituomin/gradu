...
\path{JavaCounterparts}-luokan tyhjää metodia. Molemmat kuvan
Dalvik-virtuaalikoneet ovat sama instanssi, joka on selkeyden vuoksi
...
Android-järjestelmän paketteihin otettiin mukaan perf-ohjelma sekä
...
silmukan tavukoodia tulkitaan. Ongelma on ratkaistu suorittamalla
