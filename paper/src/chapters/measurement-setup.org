...
Android-laitteessa voidaan suorittaa kokoelma minimaalisia
aliohjelmia, jotka yhdessä testaavat kattavasti JNI-rajapinnan eri
kutsuja.
...
siitä, mitkä mittausten muuttujat ovat oleellisia funktion
...
muuttujien ja vasteaikojen väliltä, nähdään saman benchmarkin
