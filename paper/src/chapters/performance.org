...
\todo{<<outo kommentti>>} # vihavaiselta
...
Benchmarking is the process of running a specific program or workload
on a specific machine or system and measuring the resulting
performance.  @@saavedra(345)
...
kokonaisuus mahdollisesti toimisi. Välittömästi on todettava, ettei
tämä lähestymistapa suinkaan ole ongelmaton.
