...
huomioida. Sitten käsittelyä syvennetään määrittelemällä mittareita,
...
määriteltyyn syötejoukkoon sekä reunaehtoihin ollakseen /validi/
@@ferrari(161--162).
...
käyttäjän subjektiivinen kokemus: käyttäjä voi kokea jopa yhtä suuriksi
...
otos kirjaamatta jokaista tilanmuutosta ohjelman sisältä käsin
...
ohjelmoida mitä tahansa räätälöityjä mittauksia.[fn:vm] 
Virtualisointimenetelmät on rajattu tutkielman ulkopuolelle, sillä tavallisessa
...
Tutkielman mittaukset tehtiin näytteenottotekniikalla, Linuxin
/perf/-työkalun avulla @@du(13). Android-laitteeseen on asennettu
uudelleenkonfiguroitu Linux-ydin, joka tukee suorituskykylaskurien
käyttöä. Itse mittaukset käynnistetään ja raportit tulostetaan ytimen
ulkopuolisilla /perf/-komentorivityökaluilla.
...
Systemaattisen ja jaksollisen näytteenoton suunnittelussa saattaa
...
suoritusympäristössä alkeisosista koostuvan ohjelman
kokonaissuoritusaikaa voi laskea deterministisesti osien
...
verrataan tavallisiin aliohjelmakutsuihin Java- ja C-kielissä. Tuloksista
