...
vasteaika ilmaisee aina tietyn operaation vasteajan tietyllä
syötteellä eli kuormituksella, ja näitä vasteajan osatekijöitä on
hyvin vaikea analysoida tavalla joka olisi riippumaton käsiteltävän
järjestelmän ominaisuuksista @@ferrari(14). Varsinaiset
suoritusaikamittaukset koskevat aina /ohjelma--syöte/-pareja, eivät
puhtaasti ohjelmaa sellaisenaan @@ferrari(455). Nämä seikat vähentävät
saatujen tulosten yleistettävyyttä. Tarkoistakin mittauksista on
vaikeaa tehdä sellaisia /yleisiä/ päätelmiä tulosten syistä, joita
voisi soveltaa myös muihin kuin juuri mitattavaan järjestelmään.
