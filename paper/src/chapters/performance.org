...
suorituskohdat, ja /validoidaan/ näin saatu suorituskykyoptimointi
...
ylipäätään suorituskykyetua tietylle sovellukselle, saa
...
riittävää abstraktiutta ja yksinkertaisuutta, mutta samalla riittävää
/tarkkuutta/ suhteessa määriteltyyn syöteavaruuteen ja reunaehtoihin
...
mallit alusta lähtien mittausten perusteella. Käsittelenkin
seuraavaksi ohjelmiston suorituskyvyn mittaamiseen käytettäviä
tekniikoita ennen käyttämieni mallinnustekniikoiden esittelyä.
...
siihen kun haluttu tulos on tulostettu käyttäjälle.
# lähde: ferrari alkusivut? spe-book?
Nykyaikaisen vuorovaikutteisen sovelluksen suorittaman laskennan ja
käyttäjän syötteiden vuorottelu voi toki olla vilkasta. Käyttäjän ja
järjestelmän laskenta voi olla osin päällekkäistäkin. Käyttäjän
odottamisesta johtuvat viiveet eivät ole osa vasteaikaa, joten
vuorovaikutukset on jaettava riittävän yksinkertaisiin mitattaviin
yksiköihin, joissa käyttäjän ja sovelluksen roolit on erotettavissa.
# lähde tuohon

Mittauksissa käytettävät vaihtelevat tekniikat mittaavat erilaisia
osia kokonaisajasta. Järjestelmän ulkopuoliselle käyttäjälle havainnot
ovat riippuvaisia todellisesta kuluneesta ajasta, /tosiajasta/
(/real time/, /wall clock time/), jota vastaa sekuntikellolla mitattu
...
kyseistä rutiinia käytetään ainoastaan kokonaisvasteaikojen
mittaamiseen, jolloin pienet häiriöt eivät ole kriittisiä.
...
Kokonaisvasteajalla on merkitystä lähinnä tulosten lopullisen
validoinnin kannalta. Tarkempi suorituskykyanalyysi vaatii tuekseen
yksityiskohtaisempia mittauksia. Niiden tavoite on purkaa vasteaika
osatekijöihin ja tunnistaa ne ohjelman osat, joiden suorituksella on
kokokonaisuuden kannalta suurin vaikutus.
