...
#+MACRO: plot_edited \begin{figure}\caption{$2}\label{fig:$1}\def\svgwidth{\textwidth}\input{figures/plots/plot-47d22819-625b-43f6-8e9f-afeb5066b758-$1-latin.pdf_tex}\end{figure}
